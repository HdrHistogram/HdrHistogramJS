...
class Float64Histogram extends AbstractHistogram {
  _counts: Float64Array;
  _totalCount: number;
  ...
  constructor(
    ...
    this._totalCount = 0;
    this._counts = new Float64Array(this.countsArrayLength);
  }
  ...
  resize(newHighestTrackableValue: number) {
    ...
    const newCounts = new Float64Array(this.countsArrayLength);
  ...
  copyCorrectedForCoordinatedOmission(
    ...
    const copy = new Float64Histogram(
