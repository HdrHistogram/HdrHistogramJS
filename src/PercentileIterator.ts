...
class PercentileIterator extends AbstractHistogramIterator {
     ...
     */
    public constructor(histogram : AbstractHistogram, percentileTicksPerHalfDistance : number) {
        super();
    ...
    private doReset(histogram: AbstractHistogram, percentileTicksPerHalfDistance: number) {
    ...
    incrementIterationLevel() {
        ...
        const percentileReportingTicks 
          = this.percentileTicksPerHalfDistance 
            * pow(2, 
                floor(log2(100 / (100 - (this.percentileLevelToIterateTo)))) + 1);
